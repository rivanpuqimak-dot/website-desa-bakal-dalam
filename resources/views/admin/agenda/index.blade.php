...
@php
    $isEditing = isset($agenda);

    $posterUrl = $isEditing && filled($agenda->poster)
        ? asset('storage/' . ltrim($agenda->poster, '/'))
        : null;
@endphp
...
<div class="admin-editor-page">
    ...
    <div class="admin-editor-header">
        <div>
            <h1>Agenda Desa</h1>
            <p>Kelola jadwal kegiatan dan agenda pemerintah desa.</p>
        </div>
        ...
        <section class="admin-editor-card">
            <div class="admin-editor-card-header">
                <div class="admin-editor-heading">
                    ...
                    <div>
                        <h2>{{ $isEditing ? 'Perbarui Agenda' : 'Tambah Agenda' }}</h2>
                        <p>Isi informasi kegiatan desa.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-editor-card-body">
                <form
                    action="{{ $isEditing
                        ? route('admin.agenda.update', $agenda->id)
                ...
                >
                    ...
                    <div
                        ...
                        id="agenda-poster-preview"
                    >
                        @if($posterUrl)
                            <img src="{{ $posterUrl }}" alt="Poster agenda">
                        @else
                            <i class="bi bi-calendar-event"></i>
                        @endif
                    </div>
                    ...
                    <div class="admin-editor-actions">
                        <button type="submit" class="admin-editor-button primary">
                            ...
                            {{ $isEditing ? 'Perbarui Agenda' : 'Simpan Agenda' }}
                        </button>
        ...
        <section class="admin-editor-card">
            <div class="admin-editor-card-header">
                <div class="admin-editor-heading">
                    ...
                    <div>
                        <h2>Daftar Agenda</h2>
                        <p>Cari agenda yang telah dibuat.</p>
                    </div>
                </div>

                <span class="admin-editor-count">
                    {{ collect($agendas ?? [])->count() }} Agenda
                </span>

                <form
                    method="GET"
                    action="{{ route('admin.agenda') }}"
                    class="admin-editor-filter"
                    style="grid-template-columns:minmax(180px,1fr) auto;"
                >
                    <input
                        type="text"
                        name="search"
                ...
                @empty
                    <div class="admin-editor-empty">
                        <div>
                            ...
                            <p>Agenda akan tampil setelah ditambahkan.</p>
                        </div>
                    </div>
                @endforelse
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const preview = document.getElementById('agenda-poster-preview');
    ...
    input?.addEventListener('change', function () {
        ...
        image.src = url;
        image.alt = 'Pratinjau poster agenda';
