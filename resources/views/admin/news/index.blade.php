...
@php
    $isEditing = isset($editNews);

    $newsImage = $isEditing && filled($editNews->gambar)
        ? asset('storage/' . ltrim($editNews->gambar, '/'))
        : null;
...
<div class="admin-editor-page">
    ...
    <div class="admin-editor-header">
        <div>
            <h1>Berita Desa</h1>
            <p>Kelola artikel, kabar kegiatan, dan publikasi desa.</p>
        </div>
        ...
        <section class="admin-editor-card">
            <div class="admin-editor-card-header">
                <div class="admin-editor-heading">
                    ...
                    <div>
                        <h2>{{ $isEditing ? 'Perbarui Berita' : 'Tambah Berita' }}</h2>
                        <p>Isi materi berita yang akan dipublikasikan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-editor-card-body">
                <form
                    action="{{ $isEditing
                        ? route('admin.berita.update', $editNews->id)
                ...
                >
                    ...
                    <div class="admin-editor-fields">
                        ...
                        <div class="admin-editor-field">
                            ...
                            <input
                                ...
                                value="{{ old(
                                    'published_at',
                                    isset($editNews->published_at)
                                        ? $editNews->published_at->format('Y-m-d')
                                        : ''
                                ) }}"
                            >
                        </div>
                    ...
                    >
                        @if($newsImage)
                            <img src="{{ $newsImage }}" alt="Gambar berita">
                        @else
        ...
        <section class="admin-editor-card">
            <div class="admin-editor-card-header">
                <div class="admin-editor-heading">
                    ...
                    <div>
                        <h2>Daftar Berita</h2>
                        <p>Cari dan filter berita yang telah dibuat.</p>
                    </div>
                </div>

                <span class="admin-editor-count">
                    {{ collect($news ?? [])->count() }} Berita
                </span>
                ...
                @empty
                    <div class="admin-editor-empty">
                        <div>
                            ...
                            <p>Berita akan tampil setelah ditambahkan.</p>
                        </div>
                    </div>
                @endforelse
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    input?.addEventListener('change', function () {
        ...
        image.src = url;
        image.alt = 'Pratinjau gambar berita';
