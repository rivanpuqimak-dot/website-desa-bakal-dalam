...
@php
    ...
    $bpdPhoto = $isEditing && filled($bpd->foto)
        ? asset('storage/' . ltrim($bpd->foto, '/'))
        : null;

    $bpdInitial = strtoupper(
        mb_substr($bpd->nama ?? 'B', 0, 1)
    );
@endphp
...
<div class="admin-data-page">
    ...
    <div class="admin-data-header">
        ...
        <div>
            <h1>Badan Permusyawaratan Desa</h1>

            <p>
                Kelola data anggota dan pengurus BPD.
            </p>
        </div>
    ...
    <div class="admin-data-layout">
        ...
        <section class="admin-data-card">
            ...
            <div class="admin-data-card-header">
                ...
                <div class="admin-data-card-heading">
                    ...
                    <div>
                        <h2>
                            {{ $isEditing
                                ? 'Perbarui Anggota BPD'
                                : 'Tambah Anggota BPD'
                            }}
                        </h2>

                        <p>Isi data anggota BPD.</p>
                    </div>
            ...
            <div class="admin-data-card-body">
                ...
                <form
                    action="{{ $isEditing
                        ? route('admin.bpd.update', $bpd->id)
                        : route('admin.bpd.store')
                    }}"
                    method="POST"
        ...
        <section class="admin-data-card">
            ...
            <div class="admin-data-card-header">
                ...
                <div class="admin-data-card-heading">
                    ...
                    <div>
                        <h2>Daftar Anggota BPD</h2>
                        <p>Anggota BPD yang telah ditambahkan.</p>
                    </div>

                </div>

                <span class="admin-data-card-count">
                    {{ collect($bpds ?? [])->count() }} Data
                </span>
                ...
                @empty
                    ...
                    <div class="admin-data-empty">
                        ...
                        <div>
                            ...
                            <h3>Belum ada anggota BPD</h3>

                            <p>
                                Data anggota BPD akan tampil setelah ditambahkan.
                            </p>
                        </div>
